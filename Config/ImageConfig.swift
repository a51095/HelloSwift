...
struct R: Rswift.Validatable {
  ...
  struct file {
    /// Resource file `LaunchImage-414x896@3x.png`.
    static let launchImage414x8963xPng = Rswift.FileResource(bundle: R.hostingBundle, name: "LaunchImage-414x896@3x", pathExtension: "png")
    ...
    /// `bundle.url(forResource: "LaunchImage-414x896@3x", withExtension: "png")`
    static func launchImage414x8963xPng(_: Void = ()) -> Foundation.URL? {
      let fileResource = R.file.launchImage414x8963xPng
  ...
  struct image {
    /// Image `LaunchImage-414x896`.
    static let launchImage414x896 = Rswift.ImageResource(bundle: R.hostingBundle, name: "LaunchImage-414x896")
    /// Image `ad_mute`.
    ...
    #if os(iOS) || os(tvOS)
    /// `UIImage(named: "LaunchImage-414x896", bundle: ..., traitCollection: ...)`
    static func launchImage414x896(compatibleWith traitCollection: UIKit.UITraitCollection? = nil) -> UIKit.UIImage? {
      return UIKit.UIImage(resource: R.image.launchImage414x896, compatibleWith: traitCollection)
    }
    #endif
...
struct _R: Rswift.Validatable {
  ...
  struct storyboard: Rswift.Validatable {
    ...
    struct launchScreen: Rswift.StoryboardResourceWithInitialControllerType, Rswift.Validatable {
      ...
      static func validate() throws {
        if UIKit.UIImage(named: "LaunchImage-414x896.png", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'LaunchImage-414x896.png' is used in storyboard 'Launch Screen', but couldn't be loaded.") }
