...
/// 通用的网络请求方法
func NetworkRequest(url: String, method: HTTPMethod = .post, parameters: [String: Any] = [:], showErrorMsg: Bool = true, encoding: URLEncoding = .default, completionHandle: @escaping (CCResponseData) -> Void) {
    // 公共参数
