...
protocol AutoScaleCardProtocol: NSObjectProtocol {
...
// 自定义flowLayout
class AutoScaleFlowLayout: UICollectionViewFlowLayout {
...
class AutoScaleCardView: UIView {
    /// 代理对象
    weak var delegate: AutoScaleCardProtocol?
    
    /// 懒加载flowLayout
    private lazy var flowLayout: AutoScaleFlowLayout = {
        let layout = AutoScaleFlowLayout()
...
extension AutoScaleCardView: UICollectionViewDelegate, UICollectionViewDataSource {
